...
export const enemies: EnemyDefinition[] = [
  ...
  { id: "crown", name: "The Cinder Crown", tier: "boss", maxHp: 168, armor: 4, moves: [{ id: "coronate", intent: "buff", label: "Coronate", effects: [{ type: "strength", amount: 3 }] }, { id: "scepter", intent: "attack", label: "Scepter fall", damage: 18 }, { id: "ashen_tax", intent: "mixed", label: "Ashen tax", damage: 10, block: 16, effects: [{ type: "applyWeak", amount: 1 }] }] },
  { id: "loom", name: "The Pale Loom", tier: "boss", maxHp: 156, armor: 8, moves: [{ id: "thread", intent: "debuff", label: "Thread the vein", effects: [{ type: "applyPoison", amount: 6 }] }, { id: "shuttle", intent: "attack", label: "Bone shuttle", damage: 7, hits: 3 }, { id: "weave", intent: "mixed", label: "Weave shut", block: 22, effects: [{ type: "applyVulnerable", amount: 1 }] }] }
];
